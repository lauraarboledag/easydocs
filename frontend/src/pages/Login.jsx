    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-16 py-12 bg-white">
        <div className="max-w-md mx-auto w-full">
          ...
          <p className="text-gray-500 mb-8">Ingresa tus credenciales para acceder a tu institución.</p>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ¿No tienes cuenta?{' '}
            <Link to="/registro" className="text-[#2952cc] font-medium hover:underline">
