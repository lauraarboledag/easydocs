...
from app.domains.institutions.services import get_institution, update_institution, list_institutions
import base64
...
@router.put("/institutions/my", response_model=InstitutionResponse)
...
@router.post("/institutions/my/logo")
async def upload_logo(
    ...
    logo_base64 = f"data:{file.content_type};base64,{base64.b64encode(contents).decode()}"
